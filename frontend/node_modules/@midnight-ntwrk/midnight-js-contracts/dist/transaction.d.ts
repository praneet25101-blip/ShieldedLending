 ...
 */
export interface TransactionContext<C extends Contract.Any, ICK extends Contract.ImpureCircuitId<C> = Contract.ImpureCircuitId<C>> {
    readonly [TypeId]: TypeId;
    readonly [Internal.Submit]: () => Promise<FinalizedCallTxData<C, ICK>>;
    readonly [Internal.MergeUnsubmittedCallTxData]: (circuitId: ICK, callData: UnsubmittedCallTxData<C, ICK>, privateStateId?: PrivateStateId) => void;
 ...
 */
export declare const withContractScopedTransaction: <C extends Contract.Any, ICK extends Contract.ImpureCircuitId<C> = Contract.ImpureCircuitId<C>>(providers: ContractProviders<C, ICK>, fn: (txCtx: TransactionContext<C, ICK>) => Promise<void>, options?: ScopedTransactionOptions) => Promise<FinalizedCallTxData<C, ICK>>;
