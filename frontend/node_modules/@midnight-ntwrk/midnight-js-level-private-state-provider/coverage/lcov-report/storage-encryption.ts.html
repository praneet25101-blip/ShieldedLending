...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (data.length &lt; HEADER_LENGTH) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid encrypted data: too short');</span>
    }
&nbsp;
    const version = data[0];
    <span class="missing-if-branch" title="if path not taken" >I</span>if (version !== ENCRYPTION_VERSION) {
